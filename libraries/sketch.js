...
function draw() {  
  ...
  blurH.setUniform('texelSize', [1.0/width*map(mouseX,0,width,0.1,5), 1.0/height*map(mouseX,0,width,0.,max_blur)]);
  ...
  blurV.setUniform('texelSize', [1.0/width*map(mouseX,0,width,0.1,5), 1.0/height*map(mouseX,0,width,0.,max_blur)]);
